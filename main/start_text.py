...
async def start_cmd(bot, msg):
    txt="This is personal use bot ⚡. Only for Warlords"
    btn = InlineKeyboardMarkup([[
        InlineKeyboardButton("⚡Main channel", url="https://t.me/Anime_Complex")
        ],[
        InlineKeyboardButton("⚡,Developer", url="https://t.me/Katsuki_warlord")
    ]])
...
async def start(bot, msg, cb=True):   
    ...
    button= [[
        InlineKeyboardButton("🤖 Bot Updates", url="https://t.me/Katsuki_warlord")
        ],[
